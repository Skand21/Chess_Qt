...
extern Game *game;
ChessPiece::ChessPiece(QString place, QGraphicsItem *parent):QGraphicsPixmapItem(parent)
{
    side = place;
    isPlaced = true;
}
...
void ChessPiece::mousePressEvent(QGraphicsSceneMouseEvent *event)
{
    ...
    // Если мы нажимаем на фигуру не того цвета
    // Можно что-нибудь высвечивать
    ...
    if(!game->pieceToMove){
        ...
        game->pieceToMove->getCurrentBox()->setColor(Qt::lightGray);
